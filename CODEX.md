...
- 2026年5月2日時点で55,000円の支援、目標300,000円に対して18%、支援者2人。支援者名は出さず、「2人目の支援」「55,000円・18%」として感謝とシェア依頼に使う。
- 2026年5月7日までの短期目標は1週目30%、つまり90,000円到達。5月2日時点であと35,000円。QRコード素材は `images/campfire/campfire-qrcode.svg`。
